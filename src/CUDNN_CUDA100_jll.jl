...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUDNN_CUDA100_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("91981db5-b9f1-5001-b8b4-81f16e12aa66"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUDNN_CUDA100", artifacts_toml) for e in artifacts["CUDNN_CUDA100"]]
...
if best_platform === nothing
    @debug("Unable to load CUDNN_CUDA100; unsupported platform $(triplet(platform_key_abi()))")
else
